    ...
    <div class="flex flex-col lg:flex-row gap-6 lg:gap-12 items-start">
        ...
        <div class="w-full lg:w-1/2 flex flex-col">
            ...
            <div class="space-y-3 mb-6">
                <a href="https://wa.me/923231256645?text={{ urlencode('Hi, I am interested in ' . $product->title . ' - Rs.' . number_format($discountPrice ?? $product->price, 0) . '. I would like to place an order.') }}" target="_blank"
