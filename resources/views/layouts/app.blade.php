...
<body>
    <nav class="bg-white shadow-sm border-b border-stone-200">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-20">
                <a href="{{ url('/') }}" class="text-3xl font-bold text-stone-800" style="font-family: 'Playfair Display', serif;">HUME WEAR</a>
    ...
    <footer class="bg-stone-900 text-stone-400 py-12 mt-20">
        <div class="max-w-7xl mx-auto px-4 text-center">
            <p class="text-2xl font-bold text-white mb-2" style="font-family: 'Playfair Display', serif;">HUME WEAR</p>
            <p class="text-sm">Women's Fashion & Accessories</p>
            <p class="text-xs mt-6">&copy; {{ date('Y') }} Hume Wear. All rights reserved.</p>
        </div>
    </footer>
</body>
</html>