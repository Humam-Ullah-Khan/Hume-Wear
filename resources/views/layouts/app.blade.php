...
<body>
    ...
    <a href="https://wa.me/{{ preg_replace('/[^0-9]/', '', $siteSettings['whatsapp']) }}?text={{ urlencode('Hi! I\'m interested in your products.') }}" target="_blank" rel="noopener noreferrer" id="whatsapp-btn" class="fixed bottom-6 right-6 z-[90] group">
        <div class="relative flex items-center">
            {{-- Tooltip --}}
            <span class="hidden md:flex items-center mr-3 px-4 py-2 bg-white text-stone-700 text-sm font-medium rounded-full shadow-lg opacity-0 group-hover:opacity-100 transition-opacity duration-300 whitespace-nowrap border border-stone-100">
                Chat with us
            </span>
            {{-- Button --}}
            <div class="w-14 h-14 bg-[#25D366] rounded-full flex items-center justify-center shadow-lg hover:shadow-xl hover:scale-110 transition-all duration-300 relative">
